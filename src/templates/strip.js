...
export default function StripTemplate({variableInput}){
    return(
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 4fr',gap:'15px',width:'635px'}}>
                    ...
                    {variableInput.url===""?<img src={defsign} alt="User"/>:<img src={`https://real-pink-gazelle-tutu.cyclic.app/${variableInput.url}`} style={{width:'125px'}} alt="User"/>}
                    </div>
                    </div>
